    ...
    $( function function1() {
        ...
        $('#search').on('keyup',function(){
            ...
            $.ajax({
                ...
                url : '<?php echo e(route('searchTask')); ?>',
                dataType: 'json',
        ...
        $('.sharefv').each(function () {
            $(this).click(function () {
                ...
                $.ajax({
                    url : '<?php echo e(route('toggleShareList')); ?>',
                    dataType: 'json',
...
<?php endif; ?>
<?php /**PATH /home/truongphi/internPHP/bigproject/todo-list/resources/views/user/todo_list/layouts/script.blade.php ENDPATH**/ ?>