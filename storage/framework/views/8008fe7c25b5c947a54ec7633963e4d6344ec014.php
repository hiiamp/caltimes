...
<!-- Bootstrap  -->
<link rel="stylesheet" href="<?php echo e(asset('user/css/bootstrap.css')); ?>">
...
<!-- Stellar Parallax -->
<script src="<?php echo e(asset('user/js/jquery.stellar.min.js')); ?>"></script>
<!-- YTPlayer -->
<script src="<?php echo e(asset('user/js/jquery.mb.YTPlayer.min.js')); ?>"></script>
<!-- Owl carousel -->
