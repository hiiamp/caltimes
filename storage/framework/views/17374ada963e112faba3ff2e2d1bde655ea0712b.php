                ...
                <div class="col-md-4 animate-box">
                    <ul>
                        <li class="btn btn-primary btn-lg btn-custom has-dropdown">
                            <a href="<?php echo e(route('login')); ?>">Login<i class="icon-arrow-right3"></i></a>
                        </li>
...
<?php if(session('status')): ?>
    <dialog id="notif">
            ...
            <div class="form-group">
                <input id="ok" type="submit" value="Ok" class="btn btn-primary">
...
<?php /**PATH /home/truongphi/internPHP/bigproject/todo-list/resources/views/index.blade.php ENDPATH**/ ?>