<nav style="z-index:101; top: 150px;position: fixed" class="menu menu11">
    ...
    <a data-pjax title="Recycle" id="delete_list" class="menu-item" href="{{route('recycle')}}"> <i
                class="icon-trash2"></i> </a>
    <a data-pjax title="Favorite co-worker" id="delete_list" class="menu-item" href="{{route('favorite')}}"> <i
                class="icon-heart"></i> </a>
    <a data-pjax title="All co-worker" class="menu-item sharewith" href="{{route('worker')}}"> <i
                class="icon-share3"></i></a>
    <a data-pjax title="My profile" class="menu-item worker_joined" href="{{route('profile')}}"> <i
                class="icon-user2"></i></a>
</nav>
