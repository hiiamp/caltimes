            ...
            <div class="col-md-4 animate-box" id="todolist">
                <article class="model">
                    ...
                    <ul id="sortable1" type="status1" class="connectedSortable detail-task1">
                        @foreach($tasks as $task)
                            @if($task->status_id==1)
                                <li data-name="{{$task->name}}" data-index="{{$task->id}}"
                                    data-position="{{$task->position}}" data-status="{{$task->todo_list_id}} "
                                    class="has-dropdown">
                                    <p>
                                        <a id="name_taskp{{$task->id}}" style="color: black;">{{$task->name}}</a>
                                    </p>
                                    <span id="ats" class="ats"><span><i
                                                    class="icon-location-2"></i></span>{{$task->assign->name}}@if($task->assign->id == @Auth::user()->id)
                                            (me) @endif</span>
                                    <p class="badges">
                                    ...
                                    <p id="priority1{{$task->id}}" class="badge js-due-date-badge is-due-past"
                                       ...
                                       @elseif($task->important == 1) style="background-color: #84ceeb"
                                       ...
                                       @else title="High Priority"
                                        ...
                                        <span id="character{{$task->id}}" class="badge-text2 js-due-date-text"
                                              title="{{$task->assign->name}}"
                                              aria-label="{{$task->assign->name}}">{{$task->assign->character}}</span>
                                    </p>
                                    </span>
                                    </p>
                                </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="contact-info-wrap-flex">
                                ...
                                <div class="con-info">
                                    <input type="hidden" id="todoid" class="form-control" name="todoid"
                                           value="{{$list->id}}">
                                    <input type="hidden" id="link" class="form-control" name="link"
                                           value="{{$list->link}}">
                                    <input type="hidden" id="status" class="form-control" name="status" value="1">
                                    <input type="hidden" id="position_create" class="form-control" name="position"
                                           value="">
                ...
                <div class="col-md-8 col-md-pull-4 animate-box">
                    <div class="row form-group">
                        ...
                        <div class="col-md-12">
                            <p></p>
                            <p>Title</p>
                            <input id="name" type="name" class="form-control" name="name" cols="30" rows="1" required
                                   autofocus class="hidden_dis">
                                ...
                                <div class="con-info">
                                    ...
                                    @foreach($tasks as $task)
                                        <select class="btn prioty" name="priority" class="custom-select"
                                                id="priority{{$task->id}}">
                                            @if($task->important == 0)
                                                <option id="p0" value="0" style="background-color: #2669ea" selected>
                                                    High
                                                </option>
                                                <option id="p1" value="1" style="background-color: #84ceeb">Medium
                                                </option>
                                                <option id="p2" value="2" style="background-color: #c1c8e4">Low</option>
                                            @elseif($task->important == 1)
                                                <option id="p0" value="0" style="background-color: #2669ea">High
                                                </option>
                                            ...
                                            @else
                                                ...
                                                <option id="p2" value="2" style="background-color: #c1c8e4" selected>
                                                    Low
                                                </option>
                                            @endif
                                        </select>
