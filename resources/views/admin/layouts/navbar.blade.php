                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-search navbar-search-dark form-inline mr-3 d-none d-md-flex ml-lg-auto">
                        <div class="form-group mb-0">
                            <div class="input-group input-group-alternative">
                                ...
                                <input class="form-control" name="search" id="search-list" type="text"
                                       placeholder="Enter what you want to find..">
                                <input class="form-control" name="search" id="search-user" type="text"
                                       placeholder="Enter what you want to find..">
                            </div>
                        </div>
                    </div>
                    ...
                    <ul class="navbar-nav align-items-center d-none d-md-flex">
                        <li class="nav-item dropdown">
                            <a class="nav-link pr-0" href="{{route('home')}}" role="button" data-toggle="dropdown"
                               aria-haspopup="true"
                               aria-expanded="false">
                                <div class="media align-items-center">
                                    <span class="avatar avatar-sm rounded-circle">
                                        <span class="badge-text2 js-due-date-text" style="font-weight: 700"
                                              title="admin" aria-label="admin">{{$character}}</span>
                                    </span>
                            ...
                            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                                <div class=" dropdown-header noti-title">
                                    <h6 class="text-overflow m-0">
                                        Welcome {{\Illuminate\Support\Facades\Auth::user()->name}}!</h6>
                                </div>
